...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b6:	caea0a13          	addi	s4,s4,-850 # 6360 <malloc+0x314>
    n = write(fds[1], "x", 1);
     6ba:	00006a97          	auipc	s5,0x6
     6be:	b3ea8a93          	addi	s5,s5,-1218 # 61f8 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	c0a50513          	addi	a0,a0,-1014 # 6368 <malloc+0x31c>
     ...
     780:	c0450513          	addi	a0,a0,-1020 # 6380 <malloc+0x334>
     ...
     79a:	b8a50513          	addi	a0,a0,-1142 # 6320 <malloc+0x2d4>
     ...
     7b4:	c0050513          	addi	a0,a0,-1024 # 63b0 <malloc+0x364>
     ...
     7d2:	bfa50513          	addi	a0,a0,-1030 # 63c8 <malloc+0x37c>
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	9cc58593          	addi	a1,a1,-1588 # 61f0 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	9a050513          	addi	a0,a0,-1632 # 61e0 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	97450513          	addi	a0,a0,-1676 # 61e0 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	96050513          	addi	a0,a0,-1696 # 61e0 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	b9a58593          	addi	a1,a1,-1126 # 6458 <malloc+0x40c>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	8e050513          	addi	a0,a0,-1824 # 61e0 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	ab450513          	addi	a0,a0,-1356 # 63f8 <malloc+0x3ac>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	ab850513          	addi	a0,a0,-1352 # 6418 <malloc+0x3cc>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     978:	ab450513          	addi	a0,a0,-1356 # 6428 <malloc+0x3dc>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	ab850513          	addi	a0,a0,-1352 # 6448 <malloc+0x3fc>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a8:	a8450513          	addi	a0,a0,-1404 # 6428 <malloc+0x3dc>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	a9e50513          	addi	a0,a0,-1378 # 6460 <malloc+0x414>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	aa050513          	addi	a0,a0,-1376 # 6480 <malloc+0x434>
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	a8c50513          	addi	a0,a0,-1396 # 64a0 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	a9c98993          	addi	s3,s3,-1380 # 64c8 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	acca8a93          	addi	s5,s5,-1332 # 6500 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	a2650513          	addi	a0,a0,-1498 # 64a0 <malloc+0x454>
  ...
  if(unlink("small") < 0){
     ...
     aba:	9ea50513          	addi	a0,a0,-1558 # 64a0 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	9c850513          	addi	a0,a0,-1592 # 64a8 <malloc+0x45c>
    ...
    exit(1);
     ...
     b02:	9da50513          	addi	a0,a0,-1574 # 64d8 <malloc+0x48c>
     ...
     b20:	9f450513          	addi	a0,a0,-1548 # 6510 <malloc+0x4c4>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	a0050513          	addi	a0,a0,-1536 # 6538 <malloc+0x4ec>
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	a0450513          	addi	a0,a0,-1532 # 6558 <malloc+0x50c>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	a0050513          	addi	a0,a0,-1536 # 6570 <malloc+0x524>
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	9ee50513          	addi	a0,a0,-1554 # 6590 <malloc+0x544>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	99c50513          	addi	a0,a0,-1636 # 6590 <malloc+0x544>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	95c50513          	addi	a0,a0,-1700 # 6598 <malloc+0x54c>
    ...
    exit(1);
     ...
     c5e:	95e50513          	addi	a0,a0,-1698 # 65b8 <malloc+0x56c>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	96a50513          	addi	a0,a0,-1686 # 65e0 <malloc+0x594>
  ...
  if(unlink("big") < 0){
     ...
     ca6:	8ee50513          	addi	a0,a0,-1810 # 6590 <malloc+0x544>
     ...
     cd2:	93250513          	addi	a0,a0,-1742 # 6600 <malloc+0x5b4>
     ...
     cf0:	93c50513          	addi	a0,a0,-1732 # 6628 <malloc+0x5dc>
     ...
     d0e:	93650513          	addi	a0,a0,-1738 # 6640 <malloc+0x5f4>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	94250513          	addi	a0,a0,-1726 # 6668 <malloc+0x61c>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	92c50513          	addi	a0,a0,-1748 # 6680 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	94458593          	addi	a1,a1,-1724 # 66b0 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	8f850513          	addi	a0,a0,-1800 # 6680 <malloc+0x634>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	8e250513          	addi	a0,a0,-1822 # 6680 <malloc+0x634>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	8cc50513          	addi	a0,a0,-1844 # 6680 <malloc+0x634>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	93058593          	addi	a1,a1,-1744 # 66f8 <malloc+0x6ac>
  ...
  unlink("unlinkread");
     ...
     e34:	85050513          	addi	a0,a0,-1968 # 6680 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	84050513          	addi	a0,a0,-1984 # 6690 <malloc+0x644>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	84c50513          	addi	a0,a0,-1972 # 66b8 <malloc+0x66c>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	85050513          	addi	a0,a0,-1968 # 66d8 <malloc+0x68c>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	85c50513          	addi	a0,a0,-1956 # 6700 <malloc+0x6b4>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	86050513          	addi	a0,a0,-1952 # 6720 <malloc+0x6d4>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	86450513          	addi	a0,a0,-1948 # 6740 <malloc+0x6f4>
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	77058593          	addi	a1,a1,1904 # 66b0 <malloc+0x664>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	80858593          	addi	a1,a1,-2040 # 6768 <malloc+0x71c>
     f68:	00005517          	auipc	a0,0x5
     f6c:	7f850513          	addi	a0,a0,2040 # 6760 <malloc+0x714>
  ...
  unlink("lf1");
     ...
     f80:	7e450513          	addi	a0,a0,2020 # 6760 <malloc+0x714>
     f84:	00005097          	auipc	ra,0x5
     f88:	cf8080e7          	jalr	-776(ra) # 5c7c <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00005517          	auipc	a0,0x5
     f92:	7d250513          	addi	a0,a0,2002 # 6760 <malloc+0x714>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	7c450513          	addi	a0,a0,1988 # 6768 <malloc+0x71c>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	78c58593          	addi	a1,a1,1932 # 6768 <malloc+0x71c>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	77650513          	addi	a0,a0,1910 # 6768 <malloc+0x71c>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c82080e7          	jalr	-894(ra) # 5c7c <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00005597          	auipc	a1,0x5
    1006:	75e58593          	addi	a1,a1,1886 # 6760 <malloc+0x714>
    100a:	00005517          	auipc	a0,0x5
    100e:	75e50513          	addi	a0,a0,1886 # 6768 <malloc+0x71c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	74258593          	addi	a1,a1,1858 # 6760 <malloc+0x714>
    1026:	00006517          	auipc	a0,0x6
    102a:	84a50513          	addi	a0,a0,-1974 # 6870 <malloc+0x824>
    ...
    104c:	72850513          	addi	a0,a0,1832 # 6770 <malloc+0x724>
    ...
    1068:	72450513          	addi	a0,a0,1828 # 6788 <malloc+0x73c>
    ...
    1084:	72050513          	addi	a0,a0,1824 # 67a0 <malloc+0x754>
    ...
    10a0:	72450513          	addi	a0,a0,1828 # 67c0 <malloc+0x774>
    ...
    10bc:	73850513          	addi	a0,a0,1848 # 67f0 <malloc+0x7a4>
    ...
    10d8:	73450513          	addi	a0,a0,1844 # 6808 <malloc+0x7bc>
    ...
    10f4:	73050513          	addi	a0,a0,1840 # 6820 <malloc+0x7d4>
    ...
    1110:	73c50513          	addi	a0,a0,1852 # 6848 <malloc+0x7fc>
    ...
    112c:	75050513          	addi	a0,a0,1872 # 6878 <malloc+0x82c>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	73e98993          	addi	s3,s3,1854 # 6898 <malloc+0x84c>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	71250513          	addi	a0,a0,1810 # 68a8 <malloc+0x85c>
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	6cca0a13          	addi	s4,s4,1740 # 68c8 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	67a50513          	addi	a0,a0,1658 # 68c8 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	61250513          	addi	a0,a0,1554 # 68d0 <malloc+0x884>
    ...
    12e2:	61250513          	addi	a0,a0,1554 # 68f0 <malloc+0x8a4>
    ...
    12fe:	61650513          	addi	a0,a0,1558 # 6910 <malloc+0x8c4>
...
000000000000134c <badarg>:
{
    ...
    136a:	e2298993          	addi	s3,s3,-478 # 6188 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	77878793          	addi	a5,a5,1912 # 7b68 <malloc+0x1b1c>
  ...
  if(pid == 0){
    ...
    1450:	16478793          	addi	a5,a5,356 # 85b0 <malloc+0x2564>
    ...
    1474:	d1850513          	addi	a0,a0,-744 # 6188 <malloc+0x13c>
    ...
    148c:	53050513          	addi	a0,a0,1328 # 69b8 <malloc+0x96c>
    ...
    14ac:	48850513          	addi	a0,a0,1160 # 6930 <malloc+0x8e4>
    ...
    14cc:	48850513          	addi	a0,a0,1160 # 6950 <malloc+0x904>
    ...
    14ee:	48650513          	addi	a0,a0,1158 # 6970 <malloc+0x924>
    ...
    150e:	48e50513          	addi	a0,a0,1166 # 6998 <malloc+0x94c>
    ...
    1528:	8f450513          	addi	a0,a0,-1804 # 6e18 <malloc+0xdcc>
  ...
  if(st != 747){
    ...
    1572:	47250513          	addi	a0,a0,1138 # 69e0 <malloc+0x994>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    159c:	c4850513          	addi	a0,a0,-952 # 61e0 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    15ce:	c16a0a13          	addi	s4,s4,-1002 # 61e0 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	46ea8a93          	addi	s5,s5,1134 # 6a40 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    164e:	3c650513          	addi	a0,a0,966 # 6a10 <malloc+0x9c4>
    ...
    166a:	3c250513          	addi	a0,a0,962 # 6a28 <malloc+0x9dc>
    ...
    1688:	3cc50513          	addi	a0,a0,972 # 6a50 <malloc+0xa04>
    ...
    16ae:	b36a0a13          	addi	s4,s4,-1226 # 61e0 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    16b2:	00005a97          	auipc	s5,0x5
    16b6:	3bea8a93          	addi	s5,s5,958 # 6a70 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1700:	ae450513          	addi	a0,a0,-1308 # 61e0 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    171e:	30e50513          	addi	a0,a0,782 # 6a28 <malloc+0x9dc>
    ...
    173c:	34050513          	addi	a0,a0,832 # 6a78 <malloc+0xa2c>
...
0000000000001752 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1762:	a2a78793          	addi	a5,a5,-1494 # 6188 <malloc+0x13c>
    1766:	fcf43023          	sd	a5,-64(s0)
    176a:	00005797          	auipc	a5,0x5
    176e:	32e78793          	addi	a5,a5,814 # 6a98 <malloc+0xa4c>
    1772:	fcf43423          	sd	a5,-56(s0)
    1776:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    177a:	00005517          	auipc	a0,0x5
    177e:	32650513          	addi	a0,a0,806 # 6aa0 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    17ae:	2f650513          	addi	a0,a0,758 # 6aa0 <malloc+0xa54>
    ...
    17ca:	2fa50513          	addi	a0,a0,762 # 6ac0 <malloc+0xa74>
    ...
    17e8:	22c50513          	addi	a0,a0,556 # 6a10 <malloc+0x9c4>
    ...
    1804:	2a850513          	addi	a0,a0,680 # 6aa8 <malloc+0xa5c>
    ...
    1822:	96a50513          	addi	a0,a0,-1686 # 6188 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    1856:	27e50513          	addi	a0,a0,638 # 6ad0 <malloc+0xa84>
    ...
    1872:	27a50513          	addi	a0,a0,634 # 6ae8 <malloc+0xa9c>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1886:	21e50513          	addi	a0,a0,542 # 6aa0 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18b0:	cac50513          	addi	a0,a0,-852 # 6558 <malloc+0x50c>
    ...
    18cc:	16050513          	addi	a0,a0,352 # 6a28 <malloc+0x9dc>
  ...
  unlink("echo-ok");
    ...
    18e6:	1be50513          	addi	a0,a0,446 # 6aa0 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1910:	1f450513          	addi	a0,a0,500 # 6b00 <malloc+0xab4>
...
0000000000001930 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1978:	304a8a93          	addi	s5,s5,772 # cc78 <buf>
    197c:	864a                	mv	a2,s2
    197e:	85d6                	mv	a1,s5
    ...
    19d8:	14450513          	addi	a0,a0,324 # 6b18 <malloc+0xacc>
    ...
    1a1a:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a66:	0ce50513          	addi	a0,a0,206 # 6b30 <malloc+0xae4>
    ...
    1a82:	0ca50513          	addi	a0,a0,202 # 6b48 <malloc+0xafc>
    ...
    1ab4:	0b050513          	addi	a0,a0,176 # 6b60 <malloc+0xb14>
    ...
    1b00:	08450513          	addi	a0,a0,132 # 6b80 <malloc+0xb34>
...
0000000000001b16 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b72:	ea250513          	addi	a0,a0,-350 # 6a10 <malloc+0x9c4>
    ...
    1b8e:	00e50513          	addi	a0,a0,14 # 6b98 <malloc+0xb4c>
    ...
    1baa:	00a50513          	addi	a0,a0,10 # 6bb0 <malloc+0xb64>
...
0000000000001bca <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1c22:	df250513          	addi	a0,a0,-526 # 6a10 <malloc+0x9c4>
    ...
    1c46:	dce50513          	addi	a0,a0,-562 # 6a10 <malloc+0x9c4>
...
0000000000001c64 <forkfork>:
{
    ...
    1cc0:	f1450513          	addi	a0,a0,-236 # 6bd0 <malloc+0xb84>
    ...
    1cd2:	f5e080e7          	jalr	-162(ra) # 5c2c <exit>
{
    ...
    1d18:	ecc50513          	addi	a0,a0,-308 # 6be0 <malloc+0xb94>
...
0000000000001d2e <reparent2>:
{
  ...
  exit(0);
    ...
    1d66:	0b650513          	addi	a0,a0,182 # 6e18 <malloc+0xdcc>
...
0000000000001d96 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e04:	01850513          	addi	a0,a0,24 # 6e18 <malloc+0xdcc>
    ...
    1e30:	c7c50513          	addi	a0,a0,-900 # 6aa8 <malloc+0xa5c>
    ...
    1ea2:	d6250513          	addi	a0,a0,-670 # 6c00 <malloc+0xbb4>
    ...
    1ed6:	d4650513          	addi	a0,a0,-698 # 6c18 <malloc+0xbcc>
    ...
    1f38:	d0c50513          	addi	a0,a0,-756 # 6c40 <malloc+0xbf4>
...
0000000000001fbc <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fdc:	22050513          	addi	a0,a0,544 # 61f8 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2006:	e6da0a1b          	addiw	s4,s4,-403 # 41c64e6d <base+0x41c551f5>
    ...
    2018:	1e4b0b13          	addi	s6,s6,484 # 61f8 <malloc+0x1ac>
      link("cat", "x");
    201c:	00005c17          	auipc	s8,0x5
    2020:	c4cc0c13          	addi	s8,s8,-948 # 6c68 <malloc+0xc1c>
    2024:	a825                	j	205c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2026:	85a6                	mv	a1,s1
    2028:	00005517          	auipc	a0,0x5
    202c:	9e850513          	addi	a0,a0,-1560 # 6a10 <malloc+0x9c4>
...
00000000000020c0 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20f0:	bcc50513          	addi	a0,a0,-1076 # 6cb8 <malloc+0xc6c>
    ...
    2114:	b6050513          	addi	a0,a0,-1184 # 6c70 <malloc+0xc24>
    ...
    2130:	b5c50513          	addi	a0,a0,-1188 # 6c88 <malloc+0xc3c>
    ...
    214c:	b5850513          	addi	a0,a0,-1192 # 6ca0 <malloc+0xc54>
...
0000000000002198 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21b4:	35098993          	addi	s3,s3,848 # c350 <uninit+0x1de8>
    21b8:	1003d937          	lui	s2,0x1003d
    21bc:	090e                	slli	s2,s2,0x3
    21be:	48090913          	addi	s2,s2,1152 # 1003d480 <base+0x1002d808>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2202:	81250513          	addi	a0,a0,-2030 # 6a10 <malloc+0x9c4>
    ...
    2224:	ac050513          	addi	a0,a0,-1344 # 6ce0 <malloc+0xc94>
...
0000000000002244 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22a6:	76e50513          	addi	a0,a0,1902 # 6a10 <malloc+0x9c4>
    ...
    22d2:	a3250513          	addi	a0,a0,-1486 # 6d00 <malloc+0xcb4>
...
00000000000022f2 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2302:	a1a50513          	addi	a0,a0,-1510 # 6d18 <malloc+0xccc>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2334:	9e850513          	addi	a0,a0,-1560 # 6d18 <malloc+0xccc>
  ...
  close(fd);
    ...
    235a:	10a78793          	addi	a5,a5,266 # 9460 <args.1>
    235e:	00007697          	auipc	a3,0x7
    2362:	1fa68693          	addi	a3,a3,506 # 9558 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    2366:	00005717          	auipc	a4,0x5
    236a:	9c270713          	addi	a4,a4,-1598 # 6d28 <malloc+0xcdc>
    ...
    23be:	a4e50513          	addi	a0,a0,-1458 # 6e08 <malloc+0xdbc>
    ...
    23e2:	a4a50513          	addi	a0,a0,-1462 # 6e28 <malloc+0xddc>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2440:	a0c50513          	addi	a0,a0,-1524 # 6e48 <malloc+0xdfc>
    ...
    245c:	5b850513          	addi	a0,a0,1464 # 6a10 <malloc+0x9c4>
...
000000000000247c <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24ca:	54a50513          	addi	a0,a0,1354 # 6a10 <malloc+0x9c4>
...
00000000000024ea <manywrites>:
{
  ...
  exit(0);
    ...
    254e:	8ce50513          	addi	a0,a0,-1842 # 6e18 <malloc+0xdcc>
    ...
    2590:	6ecb0b13          	addi	s6,s6,1772 # cc78 <buf>
    ...
    2604:	87050513          	addi	a0,a0,-1936 # 6e70 <malloc+0xe24>
    ...
    2624:	c3850513          	addi	a0,a0,-968 # 6258 <malloc+0x20c>
...
0000000000002642 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    26bc:	4b078793          	addi	a5,a5,1200 # 7b68 <malloc+0x1b1c>
  ...
  if(ret != -1){
    ...
    26fe:	78e50513          	addi	a0,a0,1934 # 6e88 <malloc+0xe3c>
    ...
    271c:	21850513          	addi	a0,a0,536 # 6930 <malloc+0x8e4>
    ...
    273a:	21a50513          	addi	a0,a0,538 # 6950 <malloc+0x904>
    ...
    275a:	21a50513          	addi	a0,a0,538 # 6970 <malloc+0x924>
    ...
    2778:	22450513          	addi	a0,a0,548 # 6998 <malloc+0x94c>
...
000000000000278e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    27c4:	70850513          	addi	a0,a0,1800 # 6ec8 <malloc+0xe7c>
  ...
  if(n >= 0){
    ...
    27f4:	6f850513          	addi	a0,a0,1784 # 6ee8 <malloc+0xe9c>
    ...
    2812:	68250513          	addi	a0,a0,1666 # 6e90 <malloc+0xe44>
    ...
    282e:	67e50513          	addi	a0,a0,1662 # 6ea8 <malloc+0xe5c>
    ...
    2848:	68c50513          	addi	a0,a0,1676 # 6ed0 <malloc+0xe84>
  ...
  unlink("rwsbrk");
    ...
    286c:	66050513          	addi	a0,a0,1632 # 6ec8 <malloc+0xe7c>
    2870:	00003097          	auipc	ra,0x3
    2874:	40c080e7          	jalr	1036(ra) # 5c7c <unlink>
  fd = open("README", O_RDONLY);
    2878:	4581                	li	a1,0
    287a:	00004517          	auipc	a0,0x4
    287e:	ae650513          	addi	a0,a0,-1306 # 6360 <malloc+0x314>
  ...
  if(n >= 0){
    ...
    28a8:	67450513          	addi	a0,a0,1652 # 6f18 <malloc+0xecc>
    ...
    28c2:	61250513          	addi	a0,a0,1554 # 6ed0 <malloc+0xe84>
...
00000000000028ec <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2948:	5fc50513          	addi	a0,a0,1532 # 6f40 <malloc+0xef4>
  ...
  for(i = 0; i < 5000; i++){
    ...
    29ac:	5b850513          	addi	a0,a0,1464 # 6f60 <malloc+0xf14>
  ...
  if(c != a + 1){
    ...
    2a10:	5b450513          	addi	a0,a0,1460 # 6fc0 <malloc+0xf74>
    ...
    2a32:	55250513          	addi	a0,a0,1362 # 6f80 <malloc+0xf34>
    ...
    2a4e:	55650513          	addi	a0,a0,1366 # 6fa0 <malloc+0xf54>
...
0000000000002a8a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b98:	44c50513          	addi	a0,a0,1100 # 6fe0 <malloc+0xf94>
    ...
    2bb4:	47850513          	addi	a0,a0,1144 # 7028 <malloc+0xfdc>
    ...
    2bd4:	47850513          	addi	a0,a0,1144 # 7048 <malloc+0xffc>
    ...
    2bf4:	49850513          	addi	a0,a0,1176 # 7088 <malloc+0x103c>
    ...
    2c10:	4ac50513          	addi	a0,a0,1196 # 70b8 <malloc+0x106c>
    ...
    2c30:	4c450513          	addi	a0,a0,1220 # 70f0 <malloc+0x10a4>
...
0000000000002c46 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c6a:	4b250513          	addi	a0,a0,1202 # 7118 <malloc+0x10cc>
    2c6e:	00003097          	auipc	ra,0x3
    2c72:	ffe080e7          	jalr	-2(ra) # 5c6c <open>
    2c76:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c78:	00004517          	auipc	a0,0x4
    2c7c:	4a050513          	addi	a0,a0,1184 # 7118 <malloc+0x10cc>
  ...
  if(pipe((int *) a) != 0){
    ...
    2cd0:	45450513          	addi	a0,a0,1108 # 7120 <malloc+0x10d4>
    ...
    2cec:	45050513          	addi	a0,a0,1104 # 7138 <malloc+0x10ec>
    ...
    2d08:	e1450513          	addi	a0,a0,-492 # 6b18 <malloc+0xacc>
...
0000000000002d1e <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2d32:	42250513          	addi	a0,a0,1058 # 7150 <malloc+0x1104>
  ...
  close(fd);
    ...
    2d7a:	cb250513          	addi	a0,a0,-846 # 6a28 <malloc+0x9dc>
...
0000000000002d90 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2dc8:	05450513          	addi	a0,a0,84 # 6e18 <malloc+0xdcc>
  ...
  if(pid == 0){
    ...
    2e1e:	ffe50513          	addi	a0,a0,-2 # 6e18 <malloc+0xdcc>
  ...
  if(pid == 0){
    ...
    2e56:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x298>
    ...
    2e7e:	f9e50513          	addi	a0,a0,-98 # 6e18 <malloc+0xdcc>
...
0000000000002f7a <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2f86:	0511                	addi	a0,a0,4 # ffffffff80000004 <base+0xffffffff7fff038c>
...
0000000000002fb0 <execout>:
{
  ...
  exit(0);
    ...
    2ff2:	e2a50513          	addi	a0,a0,-470 # 6e18 <malloc+0xdcc>
    ...
    3046:	14650513          	addi	a0,a0,326 # 6188 <malloc+0x13c>
    304a:	faa43c23          	sd	a0,-72(s0)
    304e:	00003797          	auipc	a5,0x3
    3052:	1aa78793          	addi	a5,a5,426 # 61f8 <malloc+0x1ac>
...
0000000000003074 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3084:	2a850513          	addi	a0,a0,680 # 7328 <malloc+0x12dc>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3096:	0ee50513          	addi	a0,a0,238 # 7180 <malloc+0x1134>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    30ac:	13050513          	addi	a0,a0,304 # 71d8 <malloc+0x118c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    30ca:	18a50513          	addi	a0,a0,394 # 7250 <malloc+0x1204>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30e6:	1de50513          	addi	a0,a0,478 # 72c0 <malloc+0x1274>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30f8:	22450513          	addi	a0,a0,548 # 7318 <malloc+0x12cc>
  ...
  unlink("12345678901234");
    ...
    3176:	fe650513          	addi	a0,a0,-26 # 7158 <malloc+0x110c>
    ...
    3192:	01250513          	addi	a0,a0,18 # 71a0 <malloc+0x1154>
    ...
    31ae:	05e50513          	addi	a0,a0,94 # 7208 <malloc+0x11bc>
    ...
    31ca:	0ba50513          	addi	a0,a0,186 # 7280 <malloc+0x1234>
    ...
    31e6:	0fe50513          	addi	a0,a0,254 # 72e0 <malloc+0x1294>
    ...
    3202:	13a50513          	addi	a0,a0,314 # 7338 <malloc+0x12ec>
...
0000000000003218 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    3252:	12250513          	addi	a0,a0,290 # 7370 <malloc+0x1324>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    3282:	10250513          	addi	a0,a0,258 # 7380 <malloc+0x1334>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    3310:	06450513          	addi	a0,a0,100 # 7370 <malloc+0x1324>
  ...
  unlink("diskfulldir");
    ...
    3324:	05050513          	addi	a0,a0,80 # 7370 <malloc+0x1324>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    345c:	f4850513          	addi	a0,a0,-184 # 73a0 <malloc+0x1354>
...
000000000000346a <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
    ...
    348e:	f4650513          	addi	a0,a0,-186 # 73d0 <malloc+0x1384>
  ...
  if(unlink("../iputdir") < 0){
    ...
    34a2:	f7250513          	addi	a0,a0,-142 # 7410 <malloc+0x13c4>
  ...
  if(chdir("/") < 0){
    ...
    34b6:	f8e50513          	addi	a0,a0,-114 # 7440 <malloc+0x13f4>
    ...
    34d6:	f0650513          	addi	a0,a0,-250 # 73d8 <malloc+0x138c>
    ...
    34f2:	f0250513          	addi	a0,a0,-254 # 73f0 <malloc+0x13a4>
    ...
    350e:	f1650513          	addi	a0,a0,-234 # 7420 <malloc+0x13d4>
    ...
    352a:	f2250513          	addi	a0,a0,-222 # 7448 <malloc+0x13fc>
...
0000000000003540 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3572:	e6250513          	addi	a0,a0,-414 # 73d0 <malloc+0x1384>
    ...
    3586:	e8e50513          	addi	a0,a0,-370 # 7410 <malloc+0x13c4>
    ...
    35a6:	46e50513          	addi	a0,a0,1134 # 6a10 <malloc+0x9c4>
    ...
    35c2:	e1a50513          	addi	a0,a0,-486 # 73d8 <malloc+0x138c>
    ...
    35de:	e8650513          	addi	a0,a0,-378 # 7460 <malloc+0x1414>
    ...
    35fa:	e2a50513          	addi	a0,a0,-470 # 7420 <malloc+0x13d4>
...
0000000000003628 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
    ...
    364c:	e3050513          	addi	a0,a0,-464 # 7478 <malloc+0x142c>
  ...
  if(chdir("..") < 0){
    ...
    3660:	e3c50513          	addi	a0,a0,-452 # 7498 <malloc+0x144c>
  ...
  if(unlink("dir0") < 0){
    ...
    3674:	e0850513          	addi	a0,a0,-504 # 7478 <malloc+0x142c>
    ...
    3694:	d4850513          	addi	a0,a0,-696 # 73d8 <malloc+0x138c>
    ...
    36b0:	dd450513          	addi	a0,a0,-556 # 7480 <malloc+0x1434>
    ...
    36cc:	dd850513          	addi	a0,a0,-552 # 74a0 <malloc+0x1454>
    ...
    36e8:	dd450513          	addi	a0,a0,-556 # 74b8 <malloc+0x146c>
...
00000000000036fe <subdir>:
{
  ...
  unlink("ff");
    ...
    3710:	ef450513          	addi	a0,a0,-268 # 7600 <malloc+0x15b4>
    3714:	00002097          	auipc	ra,0x2
    3718:	568080e7          	jalr	1384(ra) # 5c7c <unlink>
  if(mkdir("dd") != 0){
    371c:	00004517          	auipc	a0,0x4
    3720:	db450513          	addi	a0,a0,-588 # 74d0 <malloc+0x1484>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3738:	dbc50513          	addi	a0,a0,-580 # 74f0 <malloc+0x14a4>
  ...
  write(fd, "ff", 2);
    ...
    3750:	eb458593          	addi	a1,a1,-332 # 7600 <malloc+0x15b4>
  ...
  if(unlink("dd") >= 0){
    ...
    376a:	d6a50513          	addi	a0,a0,-662 # 74d0 <malloc+0x1484>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    377e:	dce50513          	addi	a0,a0,-562 # 7548 <malloc+0x14fc>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3796:	dde50513          	addi	a0,a0,-546 # 7570 <malloc+0x1524>
  ...
  write(fd, "FF", 2);
    ...
    37ae:	df658593          	addi	a1,a1,-522 # 75a0 <malloc+0x1554>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    37ca:	de250513          	addi	a0,a0,-542 # 75a8 <malloc+0x155c>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    37e2:	49a58593          	addi	a1,a1,1178 # cc78 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3812:	dea58593          	addi	a1,a1,-534 # 75f8 <malloc+0x15ac>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    382e:	d4650513          	addi	a0,a0,-698 # 7570 <malloc+0x1524>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3844:	d3050513          	addi	a0,a0,-720 # 7570 <malloc+0x1524>
  ...
  if(chdir("dd") != 0){
    ...
    3858:	c7c50513          	addi	a0,a0,-900 # 74d0 <malloc+0x1484>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    386c:	e2850513          	addi	a0,a0,-472 # 7690 <malloc+0x1644>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3880:	e4450513          	addi	a0,a0,-444 # 76c0 <malloc+0x1674>
  ...
  if(chdir("./..") != 0){
    ...
    3894:	e6050513          	addi	a0,a0,-416 # 76f0 <malloc+0x16a4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    38aa:	d5250513          	addi	a0,a0,-686 # 75f8 <malloc+0x15ac>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    38c2:	3ba58593          	addi	a1,a1,954 # cc78 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    38e4:	c9050513          	addi	a0,a0,-880 # 7570 <malloc+0x1524>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38fc:	e8850513          	addi	a0,a0,-376 # 7780 <malloc+0x1734>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3914:	ea050513          	addi	a0,a0,-352 # 77b0 <malloc+0x1764>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    392c:	ba850513          	addi	a0,a0,-1112 # 74d0 <malloc+0x1484>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3942:	b9250513          	addi	a0,a0,-1134 # 74d0 <malloc+0x1484>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3958:	b7c50513          	addi	a0,a0,-1156 # 74d0 <malloc+0x1484>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    396c:	ed858593          	addi	a1,a1,-296 # 7840 <malloc+0x17f4>
    3970:	00004517          	auipc	a0,0x4
    3974:	e1050513          	addi	a0,a0,-496 # 7780 <malloc+0x1734>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3988:	ebc58593          	addi	a1,a1,-324 # 7840 <malloc+0x17f4>
    398c:	00004517          	auipc	a0,0x4
    3990:	e2450513          	addi	a0,a0,-476 # 77b0 <malloc+0x1764>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    39a4:	c5858593          	addi	a1,a1,-936 # 75f8 <malloc+0x15ac>
    39a8:	00004517          	auipc	a0,0x4
    39ac:	b4850513          	addi	a0,a0,-1208 # 74f0 <malloc+0x14a4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    39c0:	dc450513          	addi	a0,a0,-572 # 7780 <malloc+0x1734>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    39d4:	de050513          	addi	a0,a0,-544 # 77b0 <malloc+0x1764>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39e8:	c1450513          	addi	a0,a0,-1004 # 75f8 <malloc+0x15ac>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39fc:	db850513          	addi	a0,a0,-584 # 77b0 <malloc+0x1764>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3a10:	d7450513          	addi	a0,a0,-652 # 7780 <malloc+0x1734>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3a24:	ad050513          	addi	a0,a0,-1328 # 74f0 <malloc+0x14a4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3a38:	f5c50513          	addi	a0,a0,-164 # 7990 <malloc+0x1944>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a4c:	bb050513          	addi	a0,a0,-1104 # 75f8 <malloc+0x15ac>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a60:	a9450513          	addi	a0,a0,-1388 # 74f0 <malloc+0x14a4>
  ...
  if(unlink("dd") == 0){
    ...
    3a74:	a6050513          	addi	a0,a0,-1440 # 74d0 <malloc+0x1484>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a88:	f7c50513          	addi	a0,a0,-132 # 7a00 <malloc+0x19b4>
  ...
  if(unlink("dd") < 0){
    ...
    3a9c:	a3850513          	addi	a0,a0,-1480 # 74d0 <malloc+0x1484>
    ...
    3abe:	a1e50513          	addi	a0,a0,-1506 # 74d8 <malloc+0x148c>
    ...
    3ada:	a2250513          	addi	a0,a0,-1502 # 74f8 <malloc+0x14ac>
    ...
    3af6:	a2650513          	addi	a0,a0,-1498 # 7518 <malloc+0x14cc>
    ...
    3b12:	a4250513          	addi	a0,a0,-1470 # 7550 <malloc+0x1504>
    ...
    3b2e:	a5650513          	addi	a0,a0,-1450 # 7580 <malloc+0x1534>
    ...
    3b4a:	a7250513          	addi	a0,a0,-1422 # 75b8 <malloc+0x156c>
    ...
    3b66:	a7650513          	addi	a0,a0,-1418 # 75d8 <malloc+0x158c>
    ...
    3b82:	a8a50513          	addi	a0,a0,-1398 # 7608 <malloc+0x15bc>
    ...
    3b9e:	a9650513          	addi	a0,a0,-1386 # 7630 <malloc+0x15e4>
    ...
    3bba:	a9a50513          	addi	a0,a0,-1382 # 7650 <malloc+0x1604>
    ...
    3bd6:	aa650513          	addi	a0,a0,-1370 # 7678 <malloc+0x162c>
    ...
    3bf2:	ab250513          	addi	a0,a0,-1358 # 76a0 <malloc+0x1654>
    ...
    3c0e:	ac650513          	addi	a0,a0,-1338 # 76d0 <malloc+0x1684>
    ...
    3c2a:	ad250513          	addi	a0,a0,-1326 # 76f8 <malloc+0x16ac>
    ...
    3c46:	ace50513          	addi	a0,a0,-1330 # 7710 <malloc+0x16c4>
    ...
    3c62:	ad250513          	addi	a0,a0,-1326 # 7730 <malloc+0x16e4>
    ...
    3c7e:	ad650513          	addi	a0,a0,-1322 # 7750 <malloc+0x1704>
    ...
    3c9a:	afa50513          	addi	a0,a0,-1286 # 7790 <malloc+0x1744>
    ...
    3cb6:	b0e50513          	addi	a0,a0,-1266 # 77c0 <malloc+0x1774>
    ...
    3cd2:	b1250513          	addi	a0,a0,-1262 # 77e0 <malloc+0x1794>
    ...
    3cee:	b1650513          	addi	a0,a0,-1258 # 7800 <malloc+0x17b4>
    ...
    3d0a:	b1a50513          	addi	a0,a0,-1254 # 7820 <malloc+0x17d4>
    ...
    3d26:	b2e50513          	addi	a0,a0,-1234 # 7850 <malloc+0x1804>
    ...
    3d42:	b3a50513          	addi	a0,a0,-1222 # 7878 <malloc+0x182c>
    ...
    3d5e:	b4650513          	addi	a0,a0,-1210 # 78a0 <malloc+0x1854>
    ...
    3d7a:	b5250513          	addi	a0,a0,-1198 # 78c8 <malloc+0x187c>
    ...
    3d96:	b5650513          	addi	a0,a0,-1194 # 78e8 <malloc+0x189c>
    ...
    3db2:	b5a50513          	addi	a0,a0,-1190 # 7908 <malloc+0x18bc>
    ...
    3dce:	b6650513          	addi	a0,a0,-1178 # 7930 <malloc+0x18e4>
    ...
    3dea:	b6a50513          	addi	a0,a0,-1174 # 7950 <malloc+0x1904>
    ...
    3e06:	b6e50513          	addi	a0,a0,-1170 # 7970 <malloc+0x1924>
    ...
    3e22:	b7a50513          	addi	a0,a0,-1158 # 7998 <malloc+0x194c>
    ...
    3e3e:	7f650513          	addi	a0,a0,2038 # 7630 <malloc+0x15e4>
    ...
    3e5a:	b6250513          	addi	a0,a0,-1182 # 79b8 <malloc+0x196c>
    ...
    3e76:	b6650513          	addi	a0,a0,-1178 # 79d8 <malloc+0x198c>
    ...
    3e92:	b7a50513          	addi	a0,a0,-1158 # 7a08 <malloc+0x19bc>
    ...
    3eae:	b7e50513          	addi	a0,a0,-1154 # 7a28 <malloc+0x19dc>
...
0000000000003ec4 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3ed4:	b7050513          	addi	a0,a0,-1168 # 7a40 <malloc+0x19f4>
  ...
  if(chdir("dots") != 0){
    ...
    3ee6:	b5e50513          	addi	a0,a0,-1186 # 7a40 <malloc+0x19f4>
  ...
  if(unlink(".") == 0){
    ...
    3ef8:	97c50513          	addi	a0,a0,-1668 # 6870 <malloc+0x824>
  ...
  if(unlink("..") == 0){
    ...
    3f0a:	59250513          	addi	a0,a0,1426 # 7498 <malloc+0x144c>
  ...
  if(chdir("/") != 0){
    ...
    3f1c:	52850513          	addi	a0,a0,1320 # 7440 <malloc+0x13f4>
  ...
  if(unlink("dots/.") == 0){
    ...
    3f2e:	b7e50513          	addi	a0,a0,-1154 # 7aa8 <malloc+0x1a5c>
  ...
  if(unlink("dots/..") == 0){
    ...
    3f40:	b9450513          	addi	a0,a0,-1132 # 7ad0 <malloc+0x1a84>
  ...
  if(unlink("dots") != 0){
    ...
    3f52:	af250513          	addi	a0,a0,-1294 # 7a40 <malloc+0x19f4>
    ...
    3f70:	adc50513          	addi	a0,a0,-1316 # 7a48 <malloc+0x19fc>
    ...
    3f8c:	ad850513          	addi	a0,a0,-1320 # 7a60 <malloc+0x1a14>
    ...
    3fa8:	ad450513          	addi	a0,a0,-1324 # 7a78 <malloc+0x1a2c>
    ...
    3fc4:	ad050513          	addi	a0,a0,-1328 # 7a90 <malloc+0x1a44>
    ...
    3fe0:	46c50513          	addi	a0,a0,1132 # 7448 <malloc+0x13fc>
    ...
    3ffc:	ab850513          	addi	a0,a0,-1352 # 7ab0 <malloc+0x1a64>
    ...
    4018:	ac450513          	addi	a0,a0,-1340 # 7ad8 <malloc+0x1a8c>
    ...
    4034:	ac850513          	addi	a0,a0,-1336 # 7af8 <malloc+0x1aac>
...
000000000000404a <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4060:	abc50513          	addi	a0,a0,-1348 # 7b18 <malloc+0x1acc>
  ...
  if(chdir("dirfile") == 0){
    ...
    407c:	aa050513          	addi	a0,a0,-1376 # 7b18 <malloc+0x1acc>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4090:	ad450513          	addi	a0,a0,-1324 # 7b60 <malloc+0x1b14>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    40d0:	a9450513          	addi	a0,a0,-1388 # 7b60 <malloc+0x1b14>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    40e4:	a8058593          	addi	a1,a1,-1408 # 7b60 <malloc+0x1b14>
    40e8:	00002517          	auipc	a0,0x2
    40ec:	27850513          	addi	a0,a0,632 # 6360 <malloc+0x314>
  ...
  if(unlink("dirfile") != 0){
    ...
    4100:	a1c50513          	addi	a0,a0,-1508 # 7b18 <malloc+0x1acc>
  ...
  fd = open(".", O_RDWR);
    ...
    4116:	75e50513          	addi	a0,a0,1886 # 6870 <malloc+0x824>
  ...
  fd = open(".", 0);
    ...
    412c:	74850513          	addi	a0,a0,1864 # 6870 <malloc+0x824>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    4140:	0bc58593          	addi	a1,a1,188 # 61f8 <malloc+0x1ac>
  ...
  close(fd);
    ...
    416c:	9b850513          	addi	a0,a0,-1608 # 7b20 <malloc+0x1ad4>
    ...
    4188:	9bc50513          	addi	a0,a0,-1604 # 7b40 <malloc+0x1af4>
    ...
    41a4:	9d050513          	addi	a0,a0,-1584 # 7b70 <malloc+0x1b24>
    ...
    41c0:	9b450513          	addi	a0,a0,-1612 # 7b70 <malloc+0x1b24>
    ...
    41dc:	9c050513          	addi	a0,a0,-1600 # 7b98 <malloc+0x1b4c>
    ...
    41f8:	9cc50513          	addi	a0,a0,-1588 # 7bc0 <malloc+0x1b74>
    ...
    4214:	9d850513          	addi	a0,a0,-1576 # 7be8 <malloc+0x1b9c>
    ...
    4230:	9e450513          	addi	a0,a0,-1564 # 7c10 <malloc+0x1bc4>
    ...
    424c:	9e850513          	addi	a0,a0,-1560 # 7c30 <malloc+0x1be4>
    ...
    4268:	9f450513          	addi	a0,a0,-1548 # 7c58 <malloc+0x1c0c>
...
000000000000427e <iref>:
{
    ...
    429c:	9d8a0a13          	addi	s4,s4,-1576 # 7c70 <malloc+0x1c24>
    mkdir("");
    42a0:	00003497          	auipc	s1,0x3
    42a4:	4d848493          	addi	s1,s1,1240 # 7778 <malloc+0x172c>
    link("README", "");
    42a8:	00002a97          	auipc	s5,0x2
    42ac:	0b8a8a93          	addi	s5,s5,184 # 6360 <malloc+0x314>
    fd = open("xx", O_CREATE);
    42b0:	00004997          	auipc	s3,0x4
    42b4:	8b898993          	addi	s3,s3,-1864 # 7b68 <malloc+0x1b1c>
    42b8:	a891                	j	430c <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    42ba:	85da                	mv	a1,s6
    42bc:	00004517          	auipc	a0,0x4
    42c0:	9bc50513          	addi	a0,a0,-1604 # 7c78 <malloc+0x1c2c>
    ...
    42dc:	9b850513          	addi	a0,a0,-1608 # 7c90 <malloc+0x1c44>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4370:	12c98993          	addi	s3,s3,300 # 7498 <malloc+0x144c>
    unlink("irefd");
    4374:	00004917          	auipc	s2,0x4
    4378:	8fc90913          	addi	s2,s2,-1796 # 7c70 <malloc+0x1c24>
    chdir("..");
    437c:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4398:	0ac50513          	addi	a0,a0,172 # 7440 <malloc+0x13f4>
...
00000000000043b8 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    43c8:	8e450513          	addi	a0,a0,-1820 # 7ca8 <malloc+0x1c5c>
  ...
  if(pid == 0){
    ...
    43ec:	8c050513          	addi	a0,a0,-1856 # 7ca8 <malloc+0x1c5c>
    ...
    4402:	8ca50513          	addi	a0,a0,-1846 # 7cc8 <malloc+0x1c7c>
    ...
    441e:	89650513          	addi	a0,a0,-1898 # 7cb0 <malloc+0x1c64>
    ...
    443a:	5da50513          	addi	a0,a0,1498 # 6a10 <malloc+0x9c4>
  ...
  if(unlink("oidir") != 0){
    ...
    4468:	84450513          	addi	a0,a0,-1980 # 7ca8 <malloc+0x1c5c>
    ...
    447c:	78850513          	addi	a0,a0,1928 # 6c00 <malloc+0xbb4>
...
00000000000044aa <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    44ba:	83a50513          	addi	a0,a0,-1990 # 7cf0 <malloc+0x1ca4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44e6:	80e50513          	addi	a0,a0,-2034 # 7cf0 <malloc+0x1ca4>
  ...
  sleep(10); // one second
    ...
    451e:	6b650513          	addi	a0,a0,1718 # 6bd0 <malloc+0xb84>
    ...
    4538:	7bc48493          	addi	s1,s1,1980 # 7cf0 <malloc+0x1ca4>
    453c:	4581                	li	a1,0
    453e:	8526                	mv	a0,s1
    ...
    4560:	79450513          	addi	a0,a0,1940 # 7cf0 <malloc+0x1ca4>
...
0000000000004580 <killstatus>:
{
  ...
  exit(0);
    ...
    45e6:	42e50513          	addi	a0,a0,1070 # 6a10 <malloc+0x9c4>
    ...
    460c:	6f850513          	addi	a0,a0,1784 # 7d00 <malloc+0x1cb4>
...
0000000000004622 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    464c:	58850513          	addi	a0,a0,1416 # 6bd0 <malloc+0xb84>
  ...
  if(pid2 == 0)
    ...
    467a:	39a50513          	addi	a0,a0,922 # 6a10 <malloc+0x9c4>
  ...
  if(pid3 == 0){
    ...
    46be:	b3e58593          	addi	a1,a1,-1218 # 61f8 <malloc+0x1ac>
    ...
    46e8:	32c50513          	addi	a0,a0,812 # 6a10 <malloc+0x9c4>
    ...
    4704:	62050513          	addi	a0,a0,1568 # 7d20 <malloc+0x1cd4>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4724:	55858593          	addi	a1,a1,1368 # cc78 <buf>
    ...
    4740:	5fc50513          	addi	a0,a0,1532 # 7d38 <malloc+0x1cec>
  ...
  printf("kill... ");
    ...
    476c:	5e850513          	addi	a0,a0,1512 # 7d50 <malloc+0x1d04>
  ...
  printf("wait... ");
    ...
    479a:	5ca50513          	addi	a0,a0,1482 # 7d60 <malloc+0x1d14>
...
00000000000047c6 <reparent>:
{
  ...
  exit(0);
    ...
    481a:	1fa50513          	addi	a0,a0,506 # 6a10 <malloc+0x9c4>
    ...
    4836:	36650513          	addi	a0,a0,870 # 6b98 <malloc+0xb4c>
...
0000000000004876 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    48ac:	27050513          	addi	a0,a0,624 # 6b18 <malloc+0xacc>
    ...
    48e0:	91c58593          	addi	a1,a1,-1764 # 61f8 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    49a4:	3d050513          	addi	a0,a0,976 # 7d70 <malloc+0x1d24>
    ...
    49c0:	05450513          	addi	a0,a0,84 # 6a10 <malloc+0x9c4>
    ...
    4a0c:	38850513          	addi	a0,a0,904 # 7d90 <malloc+0x1d44>
...
0000000000004a2c <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4ab0:	31450513          	addi	a0,a0,788 # 7dc0 <malloc+0x1d74>
...
0000000000004ad0 <sharedfd>:
{
  ...
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    4af4:	2f050513          	addi	a0,a0,752 # 7de0 <malloc+0x1d94>
  ...
  if(pid == 0) {
    ...
    4b72:	28250513          	addi	a0,a0,642 # 7df0 <malloc+0x1da4>
    ...
    4b8e:	28e50513          	addi	a0,a0,654 # 7e18 <malloc+0x1dcc>
  ...
  fd = open("sharedfd", 0);
    ...
    4bd2:	21250513          	addi	a0,a0,530 # 7de0 <malloc+0x1d94>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4c12:	22a50513          	addi	a0,a0,554 # 7e38 <malloc+0x1dec>
  ...
  unlink("sharedfd");
    ...
    4c4e:	19650513          	addi	a0,a0,406 # 7de0 <malloc+0x1d94>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c74:	1f050513          	addi	a0,a0,496 # 7e60 <malloc+0x1e14>
...
0000000000004c94 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4cb8:	1c478793          	addi	a5,a5,452 # 7e78 <malloc+0x1e2c>
    4cbc:	f6f43823          	sd	a5,-144(s0)
    4cc0:	00003797          	auipc	a5,0x3
    4cc4:	1c078793          	addi	a5,a5,448 # 7e80 <malloc+0x1e34>
    4cc8:	f6f43c23          	sd	a5,-136(s0)
    4ccc:	00003797          	auipc	a5,0x3
    4cd0:	1bc78793          	addi	a5,a5,444 # 7e88 <malloc+0x1e3c>
    4cd4:	f8f43023          	sd	a5,-128(s0)
    4cd8:	00003797          	auipc	a5,0x3
    4cdc:	1b878793          	addi	a5,a5,440 # 7e90 <malloc+0x1e44>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4d34:	f48a0a13          	addi	s4,s4,-184 # cc78 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d4a:	0d250513          	addi	a0,a0,210 # 6e18 <malloc+0xdcc>
    ...
    4dc4:	0d850513          	addi	a0,a0,216 # 7e98 <malloc+0x1e4c>
    ...
    4dde:	0ce50513          	addi	a0,a0,206 # 7ea8 <malloc+0x1e5c>
    ...
    4e04:	0c050513          	addi	a0,a0,192 # 7ec0 <malloc+0x1e74>
    ...
    4e34:	e4878793          	addi	a5,a5,-440 # cc78 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e8c:	04850513          	addi	a0,a0,72 # 7ed0 <malloc+0x1e84>
...
0000000000004ec0 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eee:	ffeb8b93          	addi	s7,s7,-2 # 7ee8 <malloc+0x1e9c>
  for(i = 0; i < N; i++){
    ...
    4f30:	fc450513          	addi	a0,a0,-60 # 7ef0 <malloc+0x1ea4>
    ...
    4f4e:	f9e50513          	addi	a0,a0,-98 # 7ee8 <malloc+0x1e9c>
  ...
  fd = open(".", 0);
    ...
    4f86:	8ee50513          	addi	a0,a0,-1810 # 6870 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ffe:	f1650513          	addi	a0,a0,-234 # 7f10 <malloc+0x1ec4>
    ...
    501e:	f1650513          	addi	a0,a0,-234 # 7f30 <malloc+0x1ee4>
  ...
  for(i = 0; i < N; i++){
    ...
    5056:	f0650513          	addi	a0,a0,-250 # 7f58 <malloc+0x1f0c>
    ...
    5072:	9a250513          	addi	a0,a0,-1630 # 6a10 <malloc+0x9c4>
...
000000000000521c <bigfile>:
{
  ...
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    5248:	d4c50513          	addi	a0,a0,-692 # 7f90 <malloc+0x1f44>
  ...
  fd = open("bigfile.dat", 0);
    ...
    52a4:	cf050513          	addi	a0,a0,-784 # 7f90 <malloc+0x1f44>
  ...
  for(i = 0; ; i++){
    ...
    52ba:	9c290913          	addi	s2,s2,-1598 # cc78 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    5308:	c9c50513          	addi	a0,a0,-868 # 7fa0 <malloc+0x1f54>
    ...
    5324:	ca050513          	addi	a0,a0,-864 # 7fc0 <malloc+0x1f74>
    ...
    5340:	ca450513          	addi	a0,a0,-860 # 7fe0 <malloc+0x1f94>
    ...
    535c:	ca850513          	addi	a0,a0,-856 # 8000 <malloc+0x1fb4>
    ...
    5378:	cac50513          	addi	a0,a0,-852 # 8020 <malloc+0x1fd4>
    ...
    5394:	ca850513          	addi	a0,a0,-856 # 8038 <malloc+0x1fec>
  ...
  unlink("bigfile.dat");
    ...
    53c2:	bd250513          	addi	a0,a0,-1070 # 7f90 <malloc+0x1f44>
    ...
    53e6:	c7650513          	addi	a0,a0,-906 # 8058 <malloc+0x200c>
...
00000000000053fc <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    541c:	c6050513          	addi	a0,a0,-928 # 8078 <malloc+0x202c>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    543c:	c50c8c93          	addi	s9,s9,-944 # 8088 <malloc+0x203c>
    name[0] = 'f';
    ...
    54ac:	bf050513          	addi	a0,a0,-1040 # 8098 <malloc+0x204c>
  ...
  printf("fsfull test finished\n");
    ...
    5522:	b9a50513          	addi	a0,a0,-1126 # 80b8 <malloc+0x206c>
    ...
    5550:	72ca8a93          	addi	s5,s5,1836 # cc78 <buf>
      if(cc < BSIZE)
    ...
    5578:	b3450513          	addi	a0,a0,-1228 # 80a8 <malloc+0x205c>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    55aa:	b2a50513          	addi	a0,a0,-1238 # 80d0 <malloc+0x2084>
  ...
  if(pid == 0) {
    ...
    55da:	b2250513          	addi	a0,a0,-1246 # 80f8 <malloc+0x20ac>
    ...
    55fe:	ae650513          	addi	a0,a0,-1306 # 80e0 <malloc+0x2094>
    ...
    5626:	ade50513          	addi	a0,a0,-1314 # 8100 <malloc+0x20b4>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    567e:	a8e50513          	addi	a0,a0,-1394 # 8108 <malloc+0x20bc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56e8:	b1498993          	addi	s3,s3,-1260 # 61f8 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    571a:	a4a50513          	addi	a0,a0,-1462 # 8160 <malloc+0x2114>
    ...
    573a:	9ea50513          	addi	a0,a0,-1558 # 8120 <malloc+0x20d4>
    ...
    575a:	9ea50513          	addi	a0,a0,-1558 # 8140 <malloc+0x20f4>
  ...
  while(1){
    ...
    57ae:	9d650513          	addi	a0,a0,-1578 # 8180 <malloc+0x2134>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    580c:	998b8b93          	addi	s7,s7,-1640 # 81a0 <malloc+0x2154>
    int free0 = countfree();
    int free1 = 0;
    if (runtests(quicktests, justone, continuous)) {
    5810:	00004b17          	auipc	s6,0x4
    5814:	800b0b13          	addi	s6,s6,-2048 # 9010 <quicktests>
      if(continuous != 2) {
    5818:	4a09                	li	s4,2
      }
    }
    ...
    581e:	bc6c0c13          	addi	s8,s8,-1082 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    5822:	00003d17          	auipc	s10,0x3
    5826:	996d0d13          	addi	s10,s10,-1642 # 81b8 <malloc+0x216c>
          return 1;
        }
      }
    }
    ...
    582e:	9aec8c93          	addi	s9,s9,-1618 # 81d8 <malloc+0x218c>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    590a:	90258593          	addi	a1,a1,-1790 # 8208 <malloc+0x21bc>
  ...
  char *justone = 0;
    ...
    5928:	8ec58593          	addi	a1,a1,-1812 # 8210 <malloc+0x21c4>
    ...
    593e:	92658593          	addi	a1,a1,-1754 # 8260 <malloc+0x2214>
  ...
  int continuous = 0;
    ...
    596a:	8b250513          	addi	a0,a0,-1870 # 8218 <malloc+0x21cc>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5990:	8bc50513          	addi	a0,a0,-1860 # 8248 <malloc+0x21fc>
